...
# ╔═╡ 6244c4c5-d259-44ec-8a0b-a2e2005f3fb0
#=============================================================================
...
# ╔═╡ 02aefae4-fbd3-40d3-915c-e5670dbc1b6f
md"""
...
begin
	...
	=========================================================================#
	# Give each species a label and a color for the legend in the figure.
	legend_dict = OrderedCollections.OrderedDict(
		# Species X details
		x => ["X", "Black"], 
		# Species Y details
		y => ["Y", "Red"], 
...
function model(D, variables, parameters)
	# Unpack variables
	x, y, z = variables
	# Unpack parameters
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "f17cd6211f80ae2c7f03a7ca30066b172a54cd74"
...
git-tree-sha1 = "f808fe47e9c0678c5553370818433b8d3a6e59ff"
...
git-tree-sha1 = "9c8e22b55fb9e63801fb87692a183c032321f56b"
